...
(function(factory) {
    ...
    if (typeof require === 'function' && typeof exports === 'object' && typeof module === 'object') {
        ...
        define('../bower_components/knockout.js/knockout.debug',['exports'], factory);
    } else {
...
define('extensions/extensions',['knockout', 'amplify'], function (ko, amplify) {
...
define('model/CameraSettings',['knockout', 'extensions/extensions'], function (ko) {
...
define('model/CaptureInterval',['knockout', 'extensions/extensions'], function (ko) {
...
define('model/model',['./CameraSettings', './CaptureInterval'], function (cameraSettings, captureInterval) {
...
define('model/datamodel',['./model', 'jquery'], function (model, $) {
...
define('image-utils',['config'], function (config) {
...
define('payload-builder',['config', 'image-utils', 'jquery', 'model/datamodel', 'moment'], function (config, imageUtils, $, datamodel, moment) {
...
define('services/dataservice-camera',['jquery', 'payload-builder', 'config'], function ($, builder, config) {
...
define('services/dataservice',['./dataservice-camera'], function (camera) {
...
define('services/datacontext',['./dataservice'], function (dataservice) {
...
define("bootstrap-slider", ["jquery"], (function (global) {
    return function () {
        var ret, fn;
...
define('bindings/bindings',['knockout', 'jquery', 'spinjs', 'bootstrap-slider', ], function (ko, $, Spinner) {
